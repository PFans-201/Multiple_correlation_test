...
tissue_filter  <- c("Gene.ID", "Gene.Name","liver", "stomach", "pancreas", "small.intestine.Peyer.s.patch",
                    "hypothalamus", "lung", "skeletal.muscle.tissue" ,  
                    "ectocervix","endocervix", "subcutaneous.adipose.tissue")
